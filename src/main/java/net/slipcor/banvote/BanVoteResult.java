...
public class BanVoteResult {
     ...
     * @param iInterval  ban length (in minutes)
     * @param bResult    true: target banned, false:
     * @param bType      0 = mute ; 1 = kick ; 2 = ban
     */
     ...
     *
     * @param pos the ban UID to remove
     */
     ...
     *
     * @param banned banned = true; muted = false
